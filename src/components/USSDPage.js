            ...
            <div className="body">
                <div className="container">
                    <div className="dropdown-container">
                        <select className="dropdown-input" id="projectSelect">
                        ...
                        <label className="dropdown-label" htmlFor="projectSelect"></label>
                    </div>
                </div>
                ...
                <div className="title-container">
                    ...
                    <label className="title-label">Final Message:</label>
                </div>
                <div className="title-containe">
                    <input type="text" className="title-inpu" placeholder=" " />
                    <label className="title-labe">Short Code:</label>
                </div>
